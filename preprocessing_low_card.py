...
if __name__ == "__main__":
    ...
    sample_data = pd.DataFrame({
        ...
        'employment_status': ['CA', 'CB', 'CC', 'CD'],
        'housing_status': ['BA', 'BB', 'BC', 'BD'],
        'device_os': ['linux', 'windows', 'macos', 'other'],
        'device_distinct_emails_8w': [0, 1, 2, 1],
        'month': [1, 2, 3, 4],
        'income': [0.1, 0.5, 0.9, 0.3],
        'proposed_credit_limit': [1000, 5000, 10000, 2000]
    })

    preprocessor = LowCardinalityPreprocessor()
